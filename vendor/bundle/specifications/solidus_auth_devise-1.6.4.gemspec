# -*- encoding: utf-8 -*-
# stub: solidus_auth_devise 1.6.4 ruby lib
...
Gem::Specification.new do |s|
  ...
  if s.respond_to? :specification_version then
    ...
    if Gem::Version.new(Gem::VERSION) >= Gem::Version.new('1.2.0') then
      s.add_runtime_dependency(%q<solidus_core>.freeze, ["< 3", ">= 1.0.6"])
      s.add_runtime_dependency(%q<solidus_support>.freeze, [">= 0"])
      ...
      s.add_development_dependency(%q<solidus_backend>.freeze, ["< 3", ">= 1.0.6"])
      s.add_development_dependency(%q<solidus_frontend>.freeze, ["< 3", ">= 1.0.6"])
      ...
      s.add_development_dependency(%q<factory_girl>.freeze, ["~> 4.4"])
      ...
      s.add_dependency(%q<solidus_core>.freeze, ["< 3", ">= 1.0.6"])
      s.add_dependency(%q<solidus_support>.freeze, [">= 0"])
      ...
      s.add_dependency(%q<solidus_backend>.freeze, ["< 3", ">= 1.0.6"])
      s.add_dependency(%q<solidus_frontend>.freeze, ["< 3", ">= 1.0.6"])
      ...
      s.add_dependency(%q<factory_girl>.freeze, ["~> 4.4"])
