...
Gem::Specification.new do |s|
  ...
  if s.respond_to? :specification_version then
    ...
    if Gem::Version.new(Gem::VERSION) >= Gem::Version.new('1.2.0') then
      ...
      s.add_runtime_dependency(%q<ffaker>.freeze, ["~> 2.0"])
      ...
      s.add_runtime_dependency(%q<paranoia>.freeze, [">= 2.1.4", "~> 2.1"])
      s.add_runtime_dependency(%q<premailer-rails>.freeze, [">= 0"])
      s.add_runtime_dependency(%q<rails>.freeze, ["~> 4.2.5"])
      s.add_runtime_dependency(%q<ransack>.freeze, ["~> 1.6"])
      ...
      s.add_dependency(%q<ffaker>.freeze, ["~> 2.0"])
      ...
      s.add_dependency(%q<paranoia>.freeze, [">= 2.1.4", "~> 2.1"])
      s.add_dependency(%q<premailer-rails>.freeze, [">= 0"])
      s.add_dependency(%q<rails>.freeze, ["~> 4.2.5"])
      s.add_dependency(%q<ransack>.freeze, ["~> 1.6"])
